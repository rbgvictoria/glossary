 ...
 */
class Glossary extends \App\Entities\Glossary implements \Doctrine\ORM\Proxy\Proxy
{
    /**
    ...
    public function __sleep()
    {
        if ($this->__isInitialized__) {
            return ['__isInitialized__', 'name', 'description', 'terms', 'id', 'guid', 'version', 'createdBy', 'modifiedBy', 'timestampCreated', 'timestampModified'];
        }
    ...
    {
        if ( ! $this->__isInitialized__) {
            $this->__initializer__ = function (Glossary $proxy) {
     ...
     * {@inheritDoc}
     */
    public function addTerm(\App\Entities\Term $term)
    {
